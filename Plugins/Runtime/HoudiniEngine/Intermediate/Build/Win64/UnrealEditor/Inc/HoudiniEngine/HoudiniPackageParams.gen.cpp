...
template<> HOUDINIENGINE_API UScriptStruct* StaticStruct<FHoudiniPackageParams>()
{
	...
	struct Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::ScriptStructInfo[] = {
		{ FHoudiniPackageParams::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewStructOps, TEXT("HoudiniPackageParams"), &Z_Registration_Info_UScriptStruct_HoudiniPackageParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPackageParams), 950681125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_52510792(TEXT("/Script/HoudiniEngine"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h_Statics::EnumInfo));
