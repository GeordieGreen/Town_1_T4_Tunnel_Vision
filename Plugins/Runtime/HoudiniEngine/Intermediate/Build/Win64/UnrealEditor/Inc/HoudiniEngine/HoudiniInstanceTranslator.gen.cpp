...
template<> HOUDINIENGINE_API UScriptStruct* StaticStruct<FHoudiniInstancedOutputPartData>()
{
	...
	struct Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniInstanceTranslator_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniInstanceTranslator_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniInstanceTranslator_h_1179398993(TEXT("/Script/HoudiniEngine"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniInstanceTranslator_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_subway_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniInstanceTranslator_h_Statics::ScriptStructInfo),
		nullptr, 0);
